...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new ai.docty.devicecare.DeviceCarePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin devicecare, ai.docty.devicecare.DeviceCarePlugin", e);
    }
    try {
